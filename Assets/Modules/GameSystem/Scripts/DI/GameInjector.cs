...
namespace GameSystem
{
    ...
    public static class GameInjector
    {
        ...
        private static readonly Type CONTEXT_TYPE = typeof(GameContext);
        ...
        public static T Instantiate<T>(GameContext context)
        {
        ...
        public static void InjectAll(GameContext context, IEnumerable<object> targets)
        {
        ...
        ///Use this methods to do dependency injection in our own class
        public static void Inject(GameContext context, object target)
        {
        ...
        public static void InjectByField(GameContext context, object target, FieldInfo field)
        {
        ...
        public static void InjectByMethod(GameContext context, object target, MethodInfo method)
        {
        ...
        public static object ResolveReference(GameContext context, Type type)
        {
        ...
        public static Array ResolveArrayReference(GameContext context, Type arrayType)
        {
        ...
        private static object InstantiateByConstructor(GameContext context, ConstructorInfo constructor)
        {
